...
def sitebackup(self, data):
    ...
    if data['currsitetype'] in ['html', 'php', 'php72', 'php74', 'php80',
                                'php73', 'proxy', 'mysql']:
        if not data['wp']:
...
def site_package_check(self, stype):
        ...
        if not (WOAptGet.is_installed(self, 'nginx-custom') or
            ...
            if WOAptGet.is_installed(self, 'nginx-plus'):
                ...
                Log.info(self, "WordOps detected a previously"
                               ...
                               "https://github.com/imageinabox/WordOps/issues/ \n")
    ...
    if ((pargs.php and pargs.php73) or (pargs.php and pargs.php74) or
        (pargs.php and pargs.php80) or (pargs.php and pargs.php72) or
        (pargs.php72 and pargs.php80) or (pargs.php74 and pargs.php80) or
    ...
    if ((not pargs.php72) and (not pargs.php73) and (not pargs.php74) and (not pargs.php80) and
